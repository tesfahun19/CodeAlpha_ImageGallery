...
## 🚀 Live Demo
Experience the live application here: **[[https://github.com/tesfaahun19/CodeAlpha_Portfolio.git](https://github.com/tesfahun19/CodeAlpha_Portfolio.git)]**
...
To run this project locally, clone the repository and open the index file:

1. **Clone the repository:**
   ```bash
   git clone [https://github.com/tesfaahun19/CodeAlpha_Portfolio.git](https://github.com/tesfahun19/CodeAlpha_Portfolio.git)
